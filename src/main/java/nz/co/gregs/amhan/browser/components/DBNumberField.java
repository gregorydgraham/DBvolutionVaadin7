 ...
 * @author Vaadin Ltd.
 */
public class DBNumberField extends AbstractNumberField<DBNumberField, Number> {

	/**
	 * Constructs an empty {@code NumberField}.
	 */
	private DBNumberField() {
		this(new Formatter());
	}
	 ...
	 */
	private DBNumberField(String label) {
		this();
		setLabel(label);
	}
	
	public static DBNumberField getField(PropertyWrapper<Number, DBNumber> prop){
		return new DBNumberField(prop);
	}
	 ...
	 */
	private DBNumberField(PropertyWrapper<Number, DBNumber> prop) {
		this();
	 ...
	 * @param placeholder the placeholder text to set
	 */
	private DBNumberField(String label, String placeholder) {
		this(label);
	 ...
	 */
	private DBNumberField(
			ValueChangeListener<? super ComponentValueChangeEvent<DBNumberField, Number>> listener) {
		this();
	 ...
	 * #addValueChangeListener(com.vaadin.flow.component.HasValue.ValueChangeListener)
	 */
	private DBNumberField(String label, Long initialValue,
			ValueChangeListener<? super ComponentValueChangeEvent<DBNumberField, Number>> listener) {
		this(label);
	 ...
	 */
	private DBNumberField(Formatter formatter) {
		super(
				formatter::parse,
				formatter,
				Long.MAX_VALUE,
	...
	private static class Formatter
			implements SerializableFunction<Number, String> {
		...
		private Formatter() {
			format.setMaximumFractionDigits(DBNumber.getNumericScale());
			format.setMaximumIntegerDigits(DBNumber.getNumericPrecision());
		}

		@Override
		public String apply(Number valueFromModel) {
